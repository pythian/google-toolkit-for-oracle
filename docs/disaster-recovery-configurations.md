...
2. Deployment of a Data Guard physical **standby** instance via a similar toolkit command, with additional parameters: `--cluster-type DG`, `--primary_ip_addr [IP ADDRESS]`, and `--ora-db-unique-name [UNIQUE NAME]`.
